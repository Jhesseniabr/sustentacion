...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link text-white" href="../vistas/subnav.php">
                        <i class="fas fa-tachometer-alt"></i>
                        Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="../vistas/subperfil.php">
                        <i class="fas fa-user"></i>
                        Perfil
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="../vistas/sub_contar.php">
                    <i class="fas fa-briefcase"></i>
                    Trabajos
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="../vistas/sub_conf.php">
