...
if (isset($_POST['numero_registro'])) {
    ...
    if ($cliente) {
        ...
        $cliente_nombre = $cliente['nombre'];  // Asegúrate de usar el campo correcto
        $dni = $cliente['dni'];
        ...
        $codigo_unico = $cliente['codigo_unico'];  // Asegúrate de usar el campo correcto

        // Insertar los datos del ticket en la base de datos
        $sql_ticket = "INSERT INTO ticket (numero_registro, cliente_id, codigo_unico) VALUES ('$numero_registro', '$cliente_id', '$codigo_unico')";
